...
function WorkDetails2() {
  return (
    <div>
      {/* Hero Section Start */}
      <div className="mt-20 text-center">
        <p className="text-[#DAC5A7] text-4xl sm:text-5xl md:text-9xl">Nova</p>
      ...
      <div className="flex justify-center py-4">
        <img
          src="https://res.cloudinary.com/da43e0ikj/image/upload/v1738593341/img/tyv6cinqsginfupccakq.jpg"
          alt="Work Image"
      ...
      <section>
        <div className="container max-w-7xl mx-auto mt-20">
          ...
          <div className="flex flex-col text-center">
            <span className="text-5xl sm:text-9xl text-[#edd6b6] font-extralight italic">
              Let’s make your
            </span>
            <br />
            <span className="text-5xl sm:text-9xl text-[#edd6b6] font-extralight italic mb-6">
              Website shine
            </span>
