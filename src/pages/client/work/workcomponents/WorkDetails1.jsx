...
function WorkDetails1() {
  return (
    <div>
      {/* Hero Section Start */}
      <div className="mt-20 text-center">
        <p className="text-[#DAC5A7] text-4xl sm:text-5xl md:text-9xl">Space</p>
      ...
      <div className="flex flex-wrap justify-center gap-5 py-4">
        ...
        {[
          ...
          >
            <div>
              <span className="text-[#DAC5A7] text-sm sm:text-lg">{item.label}</span>
              <br />
              <span className="text-[#DAC5A7] text-base sm:text-xl">{item.value}</span>
            </div>
          </div>
        ))}
      </div>
      ...
      <div className="flex justify-center items-center py-6 gap-2">
        ...
        <p className="text-[#EDD6B6] text-base sm:text-lg font-light">More Details</p>
      </div>
      {/* Hero Section End */}

      {/* Client Work Section Start */}
      <div className="flex justify-center py-4">
        <img
          src="https://res.cloudinary.com/da43e0ikj/image/upload/v1738593333/img/t0rje0zpvzdu9cxb9k7g.jpg"
          alt="Work Image"
      ...
      <section>
        <div className="container max-w-7xl mx-auto mt-20 text-center px-4">
          <h1 className="text-base sm:text-xl text-[#edd6b6] font-extralight mb-6">
            Project in mind?
          </h1>
          <div className="flex flex-col text-center">
            <span className="text-2xl md:text-9xl text-[#edd6b6] font-extralight italic">
              Let’s make your
            </span>
            <br />
            <span className="text-2xl md:text-9xl text-[#edd6b6] font-extralight italic mb-6">
              Website shine
            </span>
          ...
          <div className="flex justify-center mt-6">
            <a
              href="contact.html"
              className="border bg-[#edd6b6] rounded-lg px-4 py-2 text-black flex items-center"
            >
